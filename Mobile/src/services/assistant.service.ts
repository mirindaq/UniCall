...
export const assistantService = {
  ask: async (payload: AssistantAskRequest): Promise<ResponseSuccess<AssistantAskResponse>> => {
  ...
  getDefaultThread: async (): Promise<ResponseSuccess<AssistantThreadResponse>> => {
  ...
  listMessages: async (
    ...
    page = 1,
    limit = 50
  ): Promise<ResponseSuccess<PageResponse<AssistantThreadMessageResponse>>> => {
