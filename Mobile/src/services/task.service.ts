...
export const taskService = {
  listGroups: async (): Promise<ResponseSuccess<TaskGroup[]>> => {
    const { data } = await axiosClient.get<ResponseSuccess<TaskGroup[]>>(
      `${TASK_API_PREFIX}/groups`
    );
    return data;
  },

  createGroup: async (payload: CreateTaskGroupPayload): Promise<ResponseSuccess<TaskGroup>> => {
  ...
  getGroup: async (groupId: string): Promise<ResponseSuccess<TaskGroup>> => {
    const { data } = await axiosClient.get<ResponseSuccess<TaskGroup>>(
  ...
  addMembers: async (groupId: string, memberIds: string[]): Promise<ResponseSuccess<TaskGroup>> => {
    const { data } = await axiosClient.post<ResponseSuccess<TaskGroup>>(
  ...
  removeMember: async (groupId: string, memberId: string): Promise<ResponseSuccess<TaskGroup>> => {
    const { data } = await axiosClient.delete<ResponseSuccess<TaskGroup>>(
      `${TASK_API_PREFIX}/groups/${encodeURIComponent(groupId)}/members/${encodeURIComponent(
        memberId
      )}/kick`
    );
    return data;
  ...
  addColumn: async (groupId: string, payload: CreateTaskColumnPayload): Promise<ResponseSuccess<TaskGroup>> => {
    const { data } = await axiosClient.post<ResponseSuccess<TaskGroup>>(
  ...
  reorderColumns: async (
    groupId: string,
    payload: ReorderTaskColumnsPayload
  ): Promise<ResponseSuccess<TaskGroup>> => {
  ...
  listTasks: async (groupId: string, columnId?: string): Promise<ResponseSuccess<TaskItem[]>> => {
  ...
  listMyTasks: async (): Promise<ResponseSuccess<TaskItem[]>> => {
    const { data } = await axiosClient.get<ResponseSuccess<TaskItem[]>>(
      `${TASK_API_PREFIX}/my-items`
    );
    return data;
  },
  ...
  ): Promise<ResponseSuccess<TaskItem>> => {
  ...
  updateTask: async (taskId: string, payload: UpdateTaskItemPayload): Promise<ResponseSuccess<TaskItem>> => {
  ...
  getDashboard: async (groupId: string): Promise<ResponseSuccess<TaskDashboardSummary>> => {
  ...
  ): Promise<ResponseSuccess<TaskComment>> => {
  ...
  listComments: async (taskId: string): Promise<ResponseSuccess<TaskComment[]>> => {
  ...
  deleteComment: async (taskId: string, commentId: string): Promise<ResponseSuccess<void>> => {
