...
export function SuggestionCard({
  ...
  return (
    <Card className="gap-3 rounded-2xl border-0 bg-white py-3 shadow-none ring-1 ring-slate-200">
      <CardContent className="space-y-3 px-4">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <Button className="h-10 rounded-xl bg-slate-200 text-sm font-semibold text-slate-800 hover:bg-slate-300">
            Kết bạn
          </Button>
        </div>
      </CardContent>
